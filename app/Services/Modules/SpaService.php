...
class SpaService
{
    ...
    {
        return Cache::tags(['hero_slides', 'gurus', 'articles', 'galleries', 'school_profile', 'site_settings'])
            ->rememberForever('spa_home_data', function () {
    ...
    {
        return Cache::tags(['gurus'])->rememberForever('spa_guru_collection', function () {
    ...
    {
        return Cache::tags(['articles', 'categories'])->rememberForever('spa_published_news_' . ($limit ?? 'all'), function () use ($limit) {
