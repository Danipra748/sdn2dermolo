        ...
        <div class="grid gap-6 md:grid-cols-2 lg:grid-cols-3" data-news-filter-section>
            ...
            @empty
                <div class="col-span-full text-center py-12">
                    <div class="rounded-2xl border border-slate-200 bg-white p-12">
                        ...
                        <p class="mt-2 text-sm text-slate-400">Berita akan ditampilkan di sini setelah ditambahkan</p>
                    </div>
                </div>
            @endforelse
            <div class="col-span-full hidden items-center justify-center rounded-2xl border border-dashed border-slate-300 bg-white px-6 py-12 text-center text-slate-500" data-news-empty-state>
