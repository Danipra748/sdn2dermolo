...
<section class="py-16 px-4 bg-gradient-to-br from-slate-50 to-blue-50">
    <div class="max-w-6xl mx-auto">
            ...
            <div class="lg:col-span-2">
                <div class="bg-gradient-to-br from-blue-600 to-blue-700 rounded-3xl p-8 text-center text-white shadow-2xl relative overflow-hidden h-full">
                    ...
                    <div class="relative z-10">
                        {{-- Logo --}}
                        <div class="w-36 h-36 mx-auto mb-6 rounded-2xl bg-white shadow-2xl overflow-hidden border-4 border-white/30 p-1">
                            @if($profile->logo)
                                <img src="{{ asset('storage/' . $profile->logo) }}" 
                                     onerror="this.src='{{ asset('logosdreal.png') }}'; this.onerror=null;"
                                     alt="{{ $profile->school_name }}" 
                        ...
                        <div class="grid grid-cols-2 gap-4 pt-6 border-t border-white/20">
                            ...
                            <div class="bg-white/10 rounded-xl p-4 backdrop-blur-sm col-span-2">
                                <div class="text-3xl font-bold mb-1">{{ $profile->land_area ?? '1.400' }} </div>
                    ...
                    <div class="grid sm:grid-cols-2 gap-4">
                        ...
                        <div class="flex items-start gap-3 p-4 rounded-xl bg-gradient-to-br from-amber-50 to-amber-100 border border-amber-200 sm:col-span-2">
                            ...
                            <div class="flex-1">
                                ...
                                <div class="font-bold text-slate-900">Senin - Kamis: 07.00 - 14.00 WIB</div>
                            </div>
                        </div>
                    </div>
                </div>
        ...
        {{-- Quick Actions - Matching 'Kontak & Komunikasi' Style --}}
        <div class="mt-12 flex flex-col md:flex-row items-stretch gap-4 max-w-5xl mx-auto px-4 w-full">
            <a href="https://wa.me/6289668982633" target="_blank" 
               class="flex-1 group flex items-start gap-3 p-4 rounded-xl bg-gradient-to-br from-green-50 to-green-100 border border-green-200 hover:shadow-md transition-all duration-300">
                <div class="w-10 h-10 rounded-lg bg-green-600 flex items-center justify-center flex-shrink-0 shadow-sm group-hover:scale-105 transition-transform">
                ...
                <div>
                    <div class="text-xs text-slate-500 mb-1">WhatsApp Sekolah</div>
                    <div class="font-bold text-slate-900">Chat Langsung</div>
                </div>
            </a>

            <a href="https://maps.google.com/?q=SD+Negeri+2+Dermolo,+Kembang,+Jepara" target="_blank" 
               class="flex-1 group flex items-start gap-3 p-4 rounded-xl bg-gradient-to-br from-blue-50 to-blue-100 border border-blue-200 hover:shadow-md transition-all duration-300">
                <div class="w-10 h-10 rounded-lg bg-blue-600 flex items-center justify-center flex-shrink-0 shadow-sm group-hover:scale-105 transition-transform">
                    <svg class="w-5 h-5 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M17.657 16.657L13.414 20.9a1.998 1.998 0 01-2.827 0l-4.244-4.243a8 8 0 1111.314 0z"/><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M15 11a3 3 0 11-6 0 3 3 0 016 0z"/></svg>
                </div>
                <div>
                    <div class="text-xs text-slate-500 mb-1">Peta Lokasi</div>
                    <div class="font-bold text-slate-900">Buka Google Maps</div>
                </div>
            </a>
        </div>
    </div>
                    ...
                    <div class="space-y-4">
                        ...
                        <div class="flex items-center gap-4 p-4 bg-white rounded-xl shadow-sm border border-slate-200">
                            ...
                            <div>
                                ...
                                <div class="font-bold text-slate-900">6 Rombel</div>
                            </div>
                        </div>
                        @endif
                        ...
                        <div class="flex items-center gap-4 p-4 bg-white rounded-xl shadow-sm border border-slate-200">
                            ...
                            <div>
                                ...
                                <div class="font-bold text-slate-900">± {{ $profile->land_area }} </div>
                            </div>
                        </div>
                        @endif
                    </div>
