...
@section('content')
    <div class="news-page font-body bg-slate-50 pt-28 pb-16">
        <div class="max-w-[1200px] mx-auto px-6">
            <section class="news-hero bg-white border border-slate-200 rounded-[1.25rem] p-10 shadow-[0_10px_40px_rgba(0,0,0,0.08)]">
                ...
                <div class="mt-6">
                    ...
                    <p class="mt-3 text-sm text-slate-500">
                        Menampilkan: <span class="font-semibold text-slate-700">{{ $selectedCategory?->name ?? 'Semua kategori' }}</span>
                    </p>
                </div>
                <form action="{{ route('news.index') }}" method="GET" class="mt-6 news-filter grid grid-cols-1 md:grid-cols-[1.6fr_1fr_auto] gap-3 items-end">
                    ...
                    <div class="news-field flex flex-col">
                        ...
                        <select name="type" onchange="this.form.submit()" class="news-input bg-white border border-slate-200 rounded-full px-5 py-3 w-full focus:outline-none focus:border-blue-500 focus:ring-2 focus:ring-blue-500/20 cursor-pointer">
            ...
            <section class="section py-20 px-6">
                ...
                <div class="grid md:grid-cols-3 gap-6">
                    ...
                    @empty
                        <div class="col-span-3 text-slate-500 text-center py-10">Belum ada berita terbaru.</div>
                    @endforelse
                </div>
            </section>
            ...
            <section class="section pt-0 px-6">
                ...
                <div class="grid md:grid-cols-2 gap-6">
                    ...
                    @empty
                        <div class="col-span-2 text-slate-500 text-center py-10">Belum ada artikel dipublikasikan.</div>
                    @endforelse
                </div>
