...
Fasilitas Sekolah - UI dan UX
Update tampilan list card fasilitas sekolah tersebut grid yang responsive dan fleksibel serta untuk tampilan cardnya itu Card gambar dengan aspect 16:9 , di dalam gambar (tepatnya di bawah) ada judulnya dan ada shadow untuk contras teks judulnya, ketika card fasilitas tersebut di klik akan memunculkan modal yang berisi gambar , judul, dan deskripsi, tampilan modalnya fleksibel di berbagai devices.